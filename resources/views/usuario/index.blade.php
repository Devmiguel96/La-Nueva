...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <span class="navbar-header page-scroll"><a class="navbar-brand page-scroll" href="#page-top">La Nueva</a></span> 
    
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li> <a class="page-scroll" href="#portfolio">Noticias</a> </li>
        <li> <a class="page-scroll" href="#services">Servicios</a> </li>
        <li> <a class="page-scroll" href="#about">Quienes Somos</a> </li>
        <li> <a class="page-scroll" href="#team">Team</a> </li>
        <li> <a class="page-scroll" href="#contact">Contactos</a> </li>
        <li> <a class="page-scroll" href="#"><img src="img/login.png" width="20px" height="20px"> Login</a> </li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
...
<header>
  <div class="container">
    <div class="intro-text">
      ...
      <div class="intro-heading">La Verdadera Radio<br> de Sabanalarga</div>
      <a href="#portfolio" class="page-scroll btn btn-xl"><i class="fa fa-angle-double-down fa-4x"></i></a> </div>
  </div>
</header>
  ...
  <div class="container">
      ...
      <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item"> <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
            ...
            <img src="img/portfolio/portfolio1.png" class="img-responsive" alt=""> </a>
...
<section id="team" class="bg-light-gray">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-3">
        <div class="team-member"> <img src="img/team/1.jpg" class="img-responsive img-circle" alt="">
          <h4>Jessica</h4>
      ...
      <div class="col-sm-3">
        <div class="team-member"> <img src="img/team/2.jpg" class="img-responsive img-circle" alt="">
          <h4>Larry</h4>
      ...
      <div class="col-sm-3">
        <div class="team-member"> <img src="img/team/3.jpg" class="img-responsive img-circle" alt="">
          <h4>Diana</h4>
      ...
      <div class="col-sm-3">
        <div class="team-member"> <img src="img/team/4.jpg" class="img-responsive img-circle" alt="">
          <h4>Michael</h4>
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-md-8"> <span class="copyright">Copyright &copy; 2015 Your Website. Design by <a href="http://www.templategarden.com" rel="nofollow">Janus IT SAS</a></span> </div>
      <div class="col-md-4">
        <ul class="list-inline social-buttons">
          <li><a href="#"><i class="fa fa-twitter"></i></a> </li>
          <li><a href="#"><i class="fa fa-facebook"></i></a> </li>
